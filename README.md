...
``
             ...
             ┌──────────────┴──────────────┐
             │                             │
        Datos de entrada              Base operacional
             │
             ▼
            ETL
   ┌─────────┼─────────┐
   │         │         │
Cargar    Limpiar   Transformar
   │         │         │
   └─────────┼─────────┘
             ▼
      Datos procesados
     ...
     │       │        │         │
     ▼       ▼        ▼         ▼
    PCA   Supervisado  Clustering  Análisis
     │       │        │         │
     └───────┴────────┴─────────┘
                     │
                     ▼
...
│
├── mantenimiento/
│   ├── analizar_mantenimiento.py
│   ├── generar_mantenimiento.py
│   ├── graficar_mantenimiento.py
│   └── resultados/
│
├── modelos/
│   ├── clasificacion.py
...
│
├── manuales/
│   ├── Manual_Tecnico_SIG_LOG.pdf
│   ├── Manual_de_Usuario_SIG_LOG.pdf
│   ├── Diccionario_Datos_iniciales_SIG_LOG.pdf
